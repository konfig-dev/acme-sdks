...
@implementation AStoreApi

NSString* kAStoreApiErrorDomain = @"AStoreApiErrorDomain";
NSInteger kAStoreApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteOrderWithOrderId: (NSString*) orderId
    ...
    if (orderId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kAStoreApiErrorDomain code:kAStoreApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
