...
@implementation AUserApi

NSString* kAUserApiErrorDomain = @"AUserApiErrorDomain";
NSInteger kAUserApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createWithUser: (AUser*) user
    ...
    if (user == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kAUserApiErrorDomain code:kAUserApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
