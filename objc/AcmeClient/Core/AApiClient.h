 ...
 */
extern NSString *const AResponseObjectErrorKey;


@interface AApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<AConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<AResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<ASanitizer> sanitizer;
