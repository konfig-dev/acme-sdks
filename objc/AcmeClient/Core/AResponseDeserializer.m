#import "AResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const ADeserializationErrorDomainKey = @"ADeserializationErrorDomainKey";

NSInteger const ATypeMismatchErrorCode = 143553;

NSInteger const AEmptyValueOccurredErrorCode = 143509;

NSInteger const AUnknownResponseObjectErrorCode = 143528;


@interface AResponseDeserializer ()
...
@implementation AResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:ADeserializationErrorDomainKey code:ATypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ADeserializationErrorDomainKey code:AEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ADeserializationErrorDomainKey code:AUnknownResponseObjectErrorCode userInfo:userInfo];
}
