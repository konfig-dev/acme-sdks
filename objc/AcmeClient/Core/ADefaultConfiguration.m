...
#import "ABasicAuthTokenProvider.h"
#import "ALogger.h"

@interface ADefaultConfiguration ()
...
@implementation ADefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static ADefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [ABasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
