 ...
 */
extern NSString *const ADeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const ATypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const AEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const AUnknownResponseObjectErrorCode;

@protocol AResponseDeserializer <NSObject>
...
@interface AResponseDeserializer : NSObject <AResponseDeserializer>
