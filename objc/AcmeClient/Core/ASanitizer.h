...
extern NSString * APercentEscapedStringFromString(NSString *string);

extern NSString * const kAApplicationJSONType;

@protocol ASanitizer <NSObject>
...
@interface ASanitizer : NSObject <ASanitizer>
