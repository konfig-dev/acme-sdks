...
NSString * const kAApplicationJSONType = @"application/json";

NSString * APercentEscapedStringFromString(NSString *string) {
    static NSString * const kACharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kACharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kACharactersGeneralDelimitersToEncode stringByAppendingString:kACharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[AQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [ASanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[AObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [ASanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [ADefaultConfiguration sharedConfig].serializationTimeZone;
