...
// @ts-ignore
import { PetUpdateForm } from '../models';
// @ts-ignore
...
export const PetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PetUpdateForm} [petUpdateForm] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateWithForm: async (petId: number, name?: string, status?: string, petUpdateForm?: PetUpdateForm, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'petId' is not null or undefined
