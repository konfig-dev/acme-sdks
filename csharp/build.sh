...
${nuget_cmd} install src/Acme.Net/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Acme.Net.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Acme.Net.dll \
-recurse:'src/Acme.Net/*.cs' \
-doc:bin/Acme.Net.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Acme.Net.dll was created successfully"
fi
