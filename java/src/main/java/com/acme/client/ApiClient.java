...
import com.acme.client.auth.Authentication;
import com.acme.client.auth.HttpBasicAuth;
import com.acme.client.auth.HttpBearerAuth;
import com.acme.client.auth.ApiKeyAuth;
import com.acme.client.auth.OAuth;
import com.acme.client.auth.RetryingOAuth;
import com.acme.client.auth.OAuthFlow;
...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.api_key != null) {
                this.setApiKey(configuration.api_key);
            }
    ...
    public String getApiKey() {
        return ((ApiKeyAuth) this.getAuthentication("api_key")).getApiKey();
    }

    public void setApiKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api_key")).setApiKey(apiKey);
    }

    public void setApiKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api_key")).setApiKeyPrefix(prefix);
    }
     ...
     * @return a {@link com.acme.client.ApiClient} object
     */
     ...
     * @throws com.acme.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.acme.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.acme.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.acme.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.acme.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.acme.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.acme.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.acme.client.ApiException If fail to serialize the request body object into a string
     */
