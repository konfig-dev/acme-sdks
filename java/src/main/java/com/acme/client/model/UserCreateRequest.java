...
public class UserCreateRequest {
  ...
  public UserCreateRequest id(Long id) {
  ...
  **/
  ...
  public UserCreateRequest userStatus(Integer userStatus) {
  ...
  **/
   ...
   * @return the UserCreateRequest instance itself
   */
  public UserCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userCreateRequest.id) &&
        ...
        Objects.equals(this.userStatus, userCreateRequest.userStatus)&&
        Objects.equals(this.additionalProperties, userCreateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, email, password, phone, userStatus, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserCreateRequest>() {
           ...
           public UserCreateRequest read(JsonReader in) throws IOException {
             ...
             UserCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
