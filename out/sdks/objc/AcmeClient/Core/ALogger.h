...
#ifndef ADebugLogResponse
#define ADebugLogResponse(response, responseObject,request, error) [[ALogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef ADebugLog
#define ADebugLog(format, ...) [[ALogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by AConfiguration debug property
 */
