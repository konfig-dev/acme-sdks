...
namespace Acme.Net.Api
{
    ...
    public interface IPetApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Pet> AddPetAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Pet>> AddPetWithHttpInfoAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes a pet
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Pet</returns>
        System.Threading.Tasks.Task<Pet> UpdatePetAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Pet)</returns>
        System.Threading.Tasks.Task<ApiResponse<Pet>> UpdatePetWithHttpInfoAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Updates a pet in the store with form data
        /// </summary>
        /// <remarks>
    ...
    public partial class PetApi : IPetApi
    {
        ...
        {
            this.Configuration = new Acme.Net.Client.Configuration { BasePath = basePath };
        ...
        public PetApi()
        {
            this.Configuration = Acme.Net.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public PetApi(Acme.Net.Client.Configuration configuration = null)
        {
        ...
        public Acme.Net.Client.Configuration Configuration {get; set;}
        ...
        /// <param name="pet">Pet object that needs to be added to the store</param>
        /// <returns>ApiResponse of Pet</returns>
        public ApiResponse<Pet> AddPetWithHttpInfo (Pet pet)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Pet</returns>
        public async System.Threading.Tasks.Task<Pet> AddPetAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Pet> localVarResponse = await AddPetWithHttpInfoAsync(pet, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Pet)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Pet>> AddPetWithHttpInfoAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pet' is set
            if (pet == null)
                throw new ApiException(400, "Missing required parameter 'pet' when calling PetApi->AddPet");
        ...
        /// <param name="pet">Pet object that needs to be added to the store</param>
        /// <returns>ApiResponse of Pet</returns>
        public ApiResponse<Pet> UpdatePetWithHttpInfo (Pet pet)
        {
            // verify the required parameter 'pet' is set
            if (pet == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Pet</returns>
        public async System.Threading.Tasks.Task<Pet> UpdatePetAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Pet> localVarResponse = await UpdatePetWithHttpInfoAsync(pet, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Pet)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Pet>> UpdatePetWithHttpInfoAsync (Pet pet, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'pet' is set
            if (pet == null)
                throw new ApiException(400, "Missing required parameter 'pet' when calling PetApi->UpdatePet");
