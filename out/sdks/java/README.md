...
OpenAPI Petstore
- API version: 1.0.0
  - Build date: 2022-12-02T09:52:54.225702-08:00[America/Los_Angeles]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'acme-java-sdk' jar has been published to maven central.
    mavenLocal()       // Needed if the 'acme-java-sdk' jar has been published to the local maven repo.
  }
